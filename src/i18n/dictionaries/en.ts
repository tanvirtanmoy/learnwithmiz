...
export const en: Dictionary = {
  ...
  pricing: {
    ...
    fullPayment: {
      ...
      price: '€180',
      period: 'one time',
      description: 'Pay once for all 12 lessons',
      features: [
        'All 12 lessons included',
    ...
    installment: {
      ...
      price: '€60',
      period: '/ month',
      totalNote: 'Total €180 (3 months)',
      description: 'Pay in 3 monthly installments. Stops automatically after 3 months.',
      features: [
        'All 12 lessons included',
        '€60 per month × 3 months',
        'Auto-stops after 3 months',
        'Valid for 6 months',
      ],
      cta: 'Enroll (Monthly)',
      autoStopNote: '※ Payments automatically stop after 3 installments. No manual cancellation needed.',
    },
    popular: 'Popular',
  },
  ...
  checkoutSuccess: {
    ...
    description: 'Mizuki will contact you shortly to schedule your first lesson and discuss your learning goals.',
    planLabel: 'Your plan',
    fullPaymentPlan: 'One-time payment (€180)',
    installmentPlan: 'Monthly plan (€60 × 3 months)',
    nextSteps: {
      title: 'What happens next',
      steps: [
        'Mizuki will contact you by email',
        'Together you will schedule your first lesson',
        'Start learning! Complete all 12 lessons within 6 months',
      ],
    },
    validityNote: 'Your lessons are valid for 6 months from your start date. You can progress at your own pace.',
    backToHome: 'Back to Home',
  },
  ...
  checkoutCancel: {
    ...
    subtitle: 'Your checkout was not completed',
    description: 'No payment has been processed. You can try again or contact us if you have any questions.',
    retryButton: 'Back to Pricing',
  ...
  billing: {
    ...
    loading: 'Loading...',
    notFound: 'No enrollment found for this email address.',
    studentInfo: 'Student Information',
    name: 'Name',
    email: 'Email',
    enrollmentInfo: 'Enrollment Details',
    paymentOption: 'Payment Plan',
    enrollmentStatus: 'Enrollment Status',
    courseStart: 'Course Start Date',
    courseExpiry: 'Expiry Date',
    ...
    statusLabels: {
      ...
      installment_active: 'Installments Active',
      ...
      installment_3_month: 'Monthly Plan (3 months)',
    },
  },
};
